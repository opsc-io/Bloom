module.exports = [
"[project]/node_modules/typeorm/driver/cockroachdb/CockroachQueryRunner.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
     ...
     */ async query(query, parameters, useStructuredResult = false) {
        ...
        try {
            ...
            if (err.code === "40001" && this.isTransactionActive && this.transactionRetries < (this.driver.options.maxTransactionRetries || 5)) {
                ...
                const sleepTime = 2 ** this.transactionRetries * 0.1 * (Math.random() + 0.5) * 1000;
        ...
        return Promise.all(dbTables.map(async (dbTable)=>{
            ...
            table.columns = await Promise.all(dbColumns.filter((dbColumn)=>dbColumn["table_name"] === dbTable["table_name"] && dbColumn["table_schema"] === dbTable["table_schema"]).map(async (dbColumn)=>{
                ...
                if (enumType) {
                    ...
                    const enumName = builtEnumName !== enumType["name"] ? enumType["name"] : undefined;
                ...
                if (tableColumn.type === "geometry" || tableColumn.type === "geography") {
                    ...
                    if (results.length > 0) {
                        ...
                        tableColumn.srid = results[0].srid ? parseInt(results[0].srid) : undefined;
                    }
                }
                return tableColumn;
            }));
...
exports.CockroachQueryRunner = CockroachQueryRunner; //# sourceMappingURL=CockroachQueryRunner.js.map
}),
"[project]/node_modules/typeorm/driver/cockroachdb/CockroachDriver.js [app-route] (ecmascript)", ((__turbopack_context__, module, exports) => {
"use strict";
...
const CockroachQueryRunner_1 = __turbopack_context__.r("[project]/node_modules/typeorm/driver/cockroachdb/CockroachQueryRunner.js [app-route] (ecmascript)");
/**
 ...
 */ class CockroachDriver {
     ...
     */ prepareHydratedValue(value, columnMetadata) {
        ...
        if ([
            ...
            "smallint",
            "int2"
        ].some((v)=>v === columnMetadata.type) && !columnMetadata.isArray || columnMetadata.generationStrategy === "increment") {
...
exports.CockroachDriver = CockroachDriver; //# sourceMappingURL=CockroachDriver.js.map
}),
];

//# sourceMappingURL=node_modules_typeorm_driver_cockroachdb_f77b3161._.js.map