...
-- CreateIndex
CREATE INDEX "MessageAnalysis_label_idx" ON "MessageAnalysis"("label");

-- CreateIndex
CREATE INDEX "MessageAnalysis_riskLevel_idx" ON "MessageAnalysis"("riskLevel");

-- CreateIndex
CREATE INDEX "MessageAnalysis_createdAt_idx" ON "MessageAnalysis"("createdAt");

-- CreateIndex
CREATE UNIQUE INDEX "MLFeedback_analysisId_key" ON "MLFeedback"("analysisId");

-- CreateIndex
CREATE INDEX "MLFeedback_therapistId_idx" ON "MLFeedback"("therapistId");

-- CreateIndex
CREATE INDEX "MLFeedback_isCorrect_idx" ON "MLFeedback"("isCorrect");

-- CreateIndex
CREATE INDEX "MLFeedback_createdAt_idx" ON "MLFeedback"("createdAt");
...
-- AddForeignKey
ALTER TABLE "MLFeedback" ADD CONSTRAINT "MLFeedback_analysisId_fkey" FOREIGN KEY ("analysisId") REFERENCES "MessageAnalysis"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "MLFeedback" ADD CONSTRAINT "MLFeedback_therapistId_fkey" FOREIGN KEY ("therapistId") REFERENCES "user"("id") ON DELETE CASCADE ON UPDATE CASCADE;
